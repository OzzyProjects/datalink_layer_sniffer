...
void print_arp_packet(unsigned char* buffer){
    ...
    printf("   |-Opcode             : %u\t", ntohs(arphdr->opcode));
    parse_arp_opcode_field(arphdr->opcode);
...
void print_homeplug_av_header(unsigned char* buffer){
    ...
    printf("\nHomeplug AV Header\n");
    printf("   |-Protocol  : %u", home_av_hdr->protocol);
    printf("   |-Type      : %u\t", htons(home_av_hdr->type));
...
void print_lltd_header(unsigned char* buffer){
    ...
    printf("   |-Service Type          : %u\t", lltd_hdr->service_type);
    parse_lltd_service_type_field(lltd_hdr->service_type);

    printf("   |-Reserved              : %u\n", lltd_hdr->reserved);

    printf("   |-Function              : %u\t", lltd_hdr->function);
...
// creates and set up socket (setsockopt() etc...)
